...
using System.Text;
using SensingDownloader.Download.Extensions;
using SensingDownloader.Download;
using System.IO;
using System.Runtime.InteropServices;
using System.Xml.Serialization;
using System.Diagnostics;
using SensingDownloader.Download.Instrumentation;

namespace SensingDownloader.Download.PersistedList
{
    public class PersistedListExtension: IDisposable
    {
        ...
        private void PersistList(object state)
        {
            ...
            using (DownloadManager.Instance.LockDownloadList(false))
            {
                ...
                for (int i = 0; i < downloads.Count; i++)
                {
                    ...
                    di.KeyWords = downloader.KeyWords;
        ...
        private string GetDatabaseFile()
        {
            ...
            string file = Path.GetDirectoryName(Environment.CurrentDirectory + "\\" + "downloads.xml");
            return file;
        }
        ...
        private static void LoadPersistedObjects(DownloadItem[] downloads)
        {
            for (int i = 0; i < downloads.Length; i++)
            {
                ...
                Downloader d = DownloadManager.Instance.Add(
                    ...
                    false,
                    downloads[i].createdDateTime,downloads[i].KeyWords);

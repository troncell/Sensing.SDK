...
using SensingDownloader.Download.Common;
...
namespace SensingDownloader.Download
{
    public class Downloader
    {
        ...
        private Downloader(
            ...
            string localFile,string keywords)
        {
        ...
        public Downloader(
            ...
            ResourceLocation[] mirrors, 
            string localFile, 
            int segmentCount,string keywords):
            this(rl, mirrors, localFile,keywords)
        {
        ...
        public Downloader(
            ...
            DateTime createdDateTime,string keywords):
            this(rl, mirrors, localFile,keywords)
        {
            if (segments.Count > 0)
            {
